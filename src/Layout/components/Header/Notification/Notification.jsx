                ...
                .map((item, index) => (
                  <List key={index}>
                    <ListItem sx={{ alignItems: 'flex-start', gap: 2 }}>
                      ...
                      >
                        <Image src={'https://image.tmdb.org/t/p/w500/dB6Krk806zeqd0YNp2ngQ9zXteH.jpg'} />
                      </ListItemAvatar>
                      <ListItemText sx={{ m: 0 }}>
                        <Typography variant='body2'>
                          Lorem, ipsum dolor sit amet consectetur adipisicing elit. Aut possimus reiciendis nobis
                          quibusdam aperiam laborum quae, explicabo quo ea sit molestias? Ea sequi repellat
                          necessitatibus veritatis asperiores mollitia expedita quibusdam.
                        </Typography>
                      </ListItemText>
                    </ListItem>
                  </List>
