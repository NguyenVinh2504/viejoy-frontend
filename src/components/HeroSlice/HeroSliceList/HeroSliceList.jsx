    ...
    <>
      <SwiperNavigation>
        <Swiper
          ...
          navigation={true}
          slidesPerView={isLoading ? 0 : 'auto'}
          // effect={'fade'}
          loop={true}
              ...
              <SwiperSlide key={item.id}>
                ...
                >
                  ...
                  >
                    {/* background image */}
                    <Image
                      src={tmdbConfigs.backdropPath(pointDownSm ? item.poster_path : item.backdrop_path)}
                      alt={item.title}
                    />
                    <Box
                      sx={{
                    ...
                    >
                      ...
                      <Grid item lg={6} md={6} sm={8} xs={12}>
                        ...
                        >
                          ...
                          {/* title */}
                          <Typography
                            variant={pointDownSm ? 'h6' : pointDownMd ? 'h5' : pointDownLg ? 'h2' : 'h1'}
                            component={'h1'}
                            sx={{
                              fontWeight: '500',
                          ...
                          {/* title */}
                          <Typography
                            variant={pointDownMd ? 'subtitle2' : pointDownLg ? 'subtitle1' : 'h6'}
                            component={'p'}
                            sx={{
                              fontWeight: '400',
                              ...uiConfigs.style.typoLines(3)
                          ...
                          <Stack direction={'row'} spacing={pointDownSm ? 0 : pointDownLg ? 1 : 2}>
                            <CustomButton
                              startIcon={<PlayIcon />}
                              sx={{
                                display: {
