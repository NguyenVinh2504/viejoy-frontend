...
function CommentList({ listComment, isLoading, isFetchingNextPage, hasNextPage, onLoadingMore }) {
    ...
    <>
      {!isLoading &&
        (listComment.length > 0 ? (
          ...
          <Typography variant={pointDownSm ? 'body1' : 'h6'} component={'p'} mt={2} textAlign={'center'}>
