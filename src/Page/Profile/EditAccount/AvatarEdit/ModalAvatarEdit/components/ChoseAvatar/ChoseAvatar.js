  ...
  return (
    ...
    >
      ...
      <Stack flexDirection={'row'} gap={2}>
        ...
        <Button ref={btnUpdateRef} variant='contained' color='secondary' onClick={() => setIsEditing(true)}>
          Chỉnh sửa
        </Button>
        <Button ref={btnRemoveRef} variant='contained' color='secondary' onClick={handleDeleteAvatar}>
          Xóa
        </Button>
      </Stack>
      {/* Button */}
