  ...
  return (
    <Tooltip.Root>
      <Tooltip.Trigger asChild>
        <PlayButton>
          <CustomIconButton>{isPaused ? <PlayIcon /> : <PauseIcon />}</CustomIconButton>
        </PlayButton>
      </Tooltip.Trigger>
  ...
  return (
    <Tooltip.Root>
      <Tooltip.Trigger asChild>
        ...
        >
          <CustomIconButton>{isOn ? <ClosedCaptionsOnIcon /> : <ClosedCaptionsIcon />}</CustomIconButton>
        </CaptionButton>
      </Tooltip.Trigger>
      <Tooltip.Content className={tooltipStyles.tooltip} placement={tooltipPlacement}>
...
export function Fullscreen({ tooltipPlacement }) {
  ...
  return (
    <Tooltip.Root>
      <Tooltip.Trigger asChild>
        <FullscreenButton>
          <CustomIconButton>{isActive ? <FullscreenExitIcon /> : <FullscreenIcon />}</CustomIconButton>
        </FullscreenButton>
      </Tooltip.Trigger>
      <Tooltip.Content className={tooltipStyles.tooltip} placement={tooltipPlacement}>
