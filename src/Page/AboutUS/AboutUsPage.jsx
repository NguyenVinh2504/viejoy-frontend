    ...
    <>
      ...
      <Paper variant='outlined' sx={{ p: 3 }}>
        ...
        <Box component={'ul'} my={2} pl={'20px'}>
          ...
          <Typography variant='body1' component={'li'} fontWeight={'400'}>
            Trang Viejoy là một trang web cung cấp cho người dùng khả năng xem phim trực tuyến. Trang web có một thư
            viện phim khổng lồ, bao gồm các bộ phim mới nhất, phim cũ, phim bom tấn, phim nghệ thuật,...Nguồn phim được
            cung cấp từ trang
            <strong>
          ...
          <Typography variant='body1' component={'li'} fontWeight={'400'}>
            Trang website xem phim là một giải pháp tiện lợi và tiết kiệm cho những người yêu thích điện ảnh. Với sự đa
            dạng về tính năng và nội dung, các trang website xem phim đang ngày càng trở nên phổ biến và được nhiều
            người sử dụng.
          </Typography>
        </Box>
      </Paper>
